...
import COMP1023.labs.lab5.student_code as student_code
from COMP1023.labs.lab5.student_code import solve_level_one, solve_level_two, solve_level_three
...
class GameTester:
    ...
    def __init__(self, level, test_file_index=0):
        self.level_config = LEVELS[level]
        self.level = level
        self.test_file_index = test_file_index
    ...
    def load_level_data(self):
        """Load level data from GUI file."""
        filename = self.level_config["gui_file"]
        student_code.height, student_code.width, self.correct_action_string = read_level_data(filename)
    ...
    def test_student_code(self, verbose=False):
        ...
        current_test_file = test_files[self.test_file_index % len(test_files)]
        student_code.current_data_file = current_test_file
